...
/*
	The derived class inherits all of the members and methods that are declared as public or protected. If declared as private, it cannot be inherited by the derived classes. The private members can only be accessed in its own class. The private members can be accessed through accessor methods as shown in the example below. The derived class cannot inherit a member of the base class if the derived class declares another member with the same name.
*/
